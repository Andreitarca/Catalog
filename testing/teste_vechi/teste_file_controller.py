...
def teste_controller_file_studenti():
    rep_stud = ListaStudentiFile("testing/test_files/teste_repository_studenti.txt")
    validator_stud = StudentValidator()
    manage_stud = ManageStudenti(rep_stud, validator_stud)
    manage_stud.sterge_toti_studentii()
...
def teste_controller_file_discipline():
    rep_disc = ListaDisciplineFile("testing/test_files/teste_repository_discipline.txt")
    validator_disc = DisciplinaValidator()
    manage_disc = ManageDiscipline(rep_disc, validator_disc)
    manage_disc.sterge_toate_disciplinele()
...
def teste_controller_file_note():
    repo_stud = ListaStudentiFile("testing/test_files/teste_repository_studenti.txt")
    repo_disc = ListaDisciplineFile("testing/test_files/teste_repository_discipline.txt")
    validator_note = NoteValidator()
    repo_note = ListaNoteFile("testing/test_files/teste_repository_note.txt", repo_stud, repo_disc)
    manage_note = ManageNote(repo_note, validator_note, repo_stud, repo_disc)
    manage_note.sterge_toate_disciplinele_si_notele()
    manage_note.sterge_toti_studentii_si_notele()
...
def ruleaza_toate_testele_file_controller():
    teste_controller_file_studenti()
    teste_controller_file_discipline()
    teste_controller_file_note()
